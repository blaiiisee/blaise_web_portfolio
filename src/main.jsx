...
createRoot(document.getElementById('features')).render(
  <StrictMode>
    <MakeFeature Icon={LayersRoundedIcon} Name={'Tech Stack'} Left={'30%'} Top={'35%'} Width={'15.5em'} SVGs={['vite', 'nestjs', 'react', 'threejs', 'nodejs', 'postgresql']} />
    ...
    <MakeFeature Icon={CodeRoundedIcon} Name={'Programming'} Left={'25%'} Top={'67%'} Width={'14em'} SVGs={['html5', 'css3', 'typescript', 'javascript', 'python']} />
  </StrictMode>,
)
...
const himig_desc = `Himig is an AI-powered playlist generator that combines user mood inputs with their top Spotify artists to create a playlist that feels tailored to them. On the backend, I used FastAPI and Google’s Gemini API to interpret mood prompts and generate recommendations, while the Spotify Web API handles authentication, playlist creation, and pulling listening data. On the frontend, I went all-in with an interactive 3D experience built in TypeScript, making the whole thing feel alive and immersive. Overall, it was a perfect mix of AI, music, and 3D web development—probably one of my most creative projects yet!`
